...
finetuned_ckpt_path = '/share/nas2/dmohan/byol_finetuning/byol/files/finetune/hbo9tznc/BYOL_finetune_reproduce/hbo9tznc/checkpoints/epoch=299-step=3600.ckpt'
...
# SSL trained ckpt
# config = byol.config
# print(byol.encoder.dim)

# byol.eval()
# encoder = byol.encoder.cuda()
# encoder.eval()

# encoder.load_state_dict(finetuning_checkpoint)
